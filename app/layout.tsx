...
export const metadata: Metadata = {
  ...
  description:
    "Free AI readiness audit, website grader & llms.txt generator. Rate my website for free—check ChatGPT visibility, PageSpeed, schema & AEO instantly.",
  icons: {
    icon: "/favicon.svg",
  ...
  openGraph: {
    ...
    description:
      "Instant AI SEO Audit & Technical Analysis. Generate llms.txt, check website speed, security, and AI search readiness for free.",
  ...
  twitter: {
    ...
    description:
      "Run a free AI SEO audit to check website SEO, performance, and AI search readiness.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
  ...
  alternates: {
    ...
    types: {
      "application/rss+xml": [
        {
          url: "https://aiscanmysite.com/feed.xml",
          title: "AI Scan My Site RSS Feed",
        },
      ],
    },
  },
...
const webAppJsonLd = {
  ...
  description:
    "Free AI SEO Checker & Technical Website Audit Tool. Scan websites for SEO, performance, accessibility, and AI search engine visibility.",
};
    ...
    <html
      ...
      <head>
        ...
        <link
          ...
          title="AI Scan My Site RSS Feed"
          href="https://aiscanmysite.com/feed.xml"
        />
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-BYM0CFFMHX"
        />
        <script
      ...
      <body className="bg-background text-ink antialiased">
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(websiteSchemaJsonLd),
          }}
        />
        <script
          type="application/ld+json"
